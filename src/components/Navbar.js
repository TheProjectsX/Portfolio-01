...
const Navbar = () => {
  ...
  return (
    <nav className='flex flex-wrap items-center justify-between px-12 py-4 mdl:gap-x-0 sticky top-0 bg-white drop-shadow-xl'>
        <div className='logo'>
        ...
        <div className={`flex items-center w-full overflow-hidden mdl:w-fit gap-14 transition-[height] duration-200 ease-in-out h-0 mdl:h-auto  ${navOpen ? 'h-[180px]' : 'h-0'}`}>
