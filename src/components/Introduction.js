...
const Introduction = (props) => {
  return (
    <div className='flex justify-evenly bg-[#e3e4e8] w-[100vw]' id={props.id}>
        <div className="intro my-12 max-w-[350px] md:max-w-none px-2 md:p-12 md:w-1/2">
            <h2 className='text-lg sm:text-xl uppercase text-red-500 pb-2 '>Get every single solutions</h2>
            <h1 className='text-2xl sm:text-4xl text-blue-800 font-semibold pb-7 md:text-6xl'>I'm Designer Rahat Khan</h1>
